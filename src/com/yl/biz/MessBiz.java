...
public interface MessBiz {
	 ...
	 * @return 总条数集合
	 */
	int getCountByName(MessVo vo , String name , Integer pageSize);
	 ...
	 * @return 发件箱总条数集合
	 */
	int getCountBySendName(MessVo vo , String name , Integer pageSize);
	 ...
	 * @return 收件箱总条数集合
	 */
	int getCountByGetName(MessVo vo , String name , Integer pageSize);
