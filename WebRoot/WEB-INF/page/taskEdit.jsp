...
<form action="doTaskEdit.action" method="post" name="fom" id="fom">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>修改任务</legend>
					  ...
					  <tr>
					    ...
					    <td width="41%"><input name="task.taskName" value="<s:property value="task.taskName"/>" class="text" style="width:250px" type="text" size="40" />
					  ...
					  <tr>
					    ...
					    <td><input name="task.taskCreateDate" type="text" id="" class="text" style="width:154px" value="<s:date name="task.taskCreateDate" format="yyyy-MM-dd"/>"/></td>
					    <td align="right">计划结束时间:</td>
					    <td><input name="task.taskEndDate" type="text" value="<s:date name="task.taskEndDate" format="yyyy-MM-dd"/>" id="Input" class="text" style="width:154px" /></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td colspan="3"><textarea id="textarea" name="task.taskNote" rows="5" cols="80"><s:property value="task.taskNote"/></textarea></td>
					    </tr>
					  </table>
			 		<br/>
				</fieldset></TD>
