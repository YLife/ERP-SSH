...
<form action="doFunAdd.action" method="post" name="form">
<div class="MainDiv">
<input type="hidden" name="fun.emp.empId" value="106"/>
			...
			<TD width="100%">
				...
				<legend>功能</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><input name='fun.funName' type="text" class="text" style="width:154px"/>
				        <span class="red">*</span></td>
					    <td align="right">任务执行人:</td>
					    <td><input name='fun.emp.empName' type="text" class="text" style="width:154px"/></td>
					  </tr>
					  <tr>
				      ...
				      <td colspan="3"><textarea name="fun.funRemark" cols="80" rows="6"></textarea></td>
				      </tr>
					  </table>
			  		<br/>
				</fieldset>
