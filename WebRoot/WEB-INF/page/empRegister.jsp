...
/* 	//注册
	...
	function save() {
		...
		var pwd2 = document.getElementById("checkmm").value;
		if (pwd1 != pwd2) {
			alert("两次密码不一致");
			var fom = document.getElementById("fom");
			fom.action = "empRegister.action";
			fom.submit();
		} else {
			alert("通过");
...
<body>
<form action="doEmpRegister.action" method="post" id="fom">
              ...
              <tr>
                <td align="center"><table width="272" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="yhxm" type="text" dataType="Limit" require="true" msg="用户姓名不能为空"  name="emp.empName"/></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="checkmm" size="25" type="password" dataType="Limit" require="true" msg="确认密码不能为空" name="emp.empPwd"/></td>
                  </tr>
                </table></td>
                <td width="232" align="right" valign="top"><img src="user2/images/register_08.gif" width="232" height="172" /></td>
                    ...
                    <table width="623" height="41" border="0" cellpadding="0" cellspacing="0">
                      <tr align="center">
			<td width="201">&nbsp;</td>
                        <td width="107"><input onClick="javascript:save();" type="image" src="user2/images/register_22.gif" width="82" height="23"  /></td>
